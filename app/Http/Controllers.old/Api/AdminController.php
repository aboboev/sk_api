...
class AdminController extends Controller
{
    ...
    public function getCoinUsers($coin, Request $request) {
        ...
        switch ($coin) {
            case 'BTW':
                $received = $depositController->getBTWDepositByUser();
                break;
        }
        ...
        foreach ($result as $user) {
            ...
            switch ($coin) {
                case 'BTW':
                    if (isset($received[$user->id])) {
                        $user->deposit_amount = $user->deposit_amount + $received[$user->id];
                    }
                    break;
            }
    ...
    public function getDepositHistory($coin, Request $request) {
        ...
        switch ($coin) {
            case 'BTW':
                $trans = $depositController->getBTWAllDepositList();
                break;
            default: break;
        }
    ...
    public function getWalletStatistics(Request $request) {
        ...
        foreach ($result as $coin) {
            ...
            $coin->dest_amount += $depositAmount;
