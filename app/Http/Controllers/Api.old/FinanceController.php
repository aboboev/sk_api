...
class FinanceController extends Controller
{
    ...
    public function withdraw($currency, Request $request) {
        ...
        if ($currency == 'USD') {
            return response()->json([
                'success' => false,
                'error' => 'USD withdrawal is suspended, please contact with live support.'
            ]);
        }
        ...
        if ($currency == 'EURO') {
            return response()->json([
                'success' => false,
                'error' => 'EURO withdrawal is suspended, please contact with live support.'
            ]);
        }
    ...
    public function cancelTransaction(Request $request) {
        ...
        if (!$transaction || $transaction->user_id != $user->id || $transaction->type == TransactionType::WITHDRAW) {
            return response()->json([
                'success' => false,
