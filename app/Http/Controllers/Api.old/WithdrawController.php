...
//        $gasPrice = hexdec($gasPrice) * $this::CLO_UNIT;
    ...
    public function withdrawADMN($input) {
        $id = $input['id'];
        ...
        $controller = new WalletController();
        $balance = $controller->getADMNTotalBalance();
...
//            $jsonRpc->close_wallet(array());
    ...
    public function withdrawCMM($input) {
        $id = $input['id'];
    ...
    public function withdrawCDZC($input) {
        $id = $input['id'];
